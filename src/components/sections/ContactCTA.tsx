        ...
        >
          ...
          >
            ...
            <button
              ...
              className="group inline-flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-600 text-white px-3.5 sm:px-5 md:px-6 lg:px-8 py-2 sm:py-3 md:py-3.5 lg:py-4 rounded-lg sm:rounded-xl font-outfit font-semibold transition-all duration-300 shadow-lg hover:shadow-xl hover:shadow-blue-500/25 focus-override w-full sm:w-auto min-h-[40px] sm:min-h-[48px] md:min-h-[52px] lg:min-h-[56px] text-sm sm:text-base"
            >
              {primaryButtonText}
            ...
            <button
              ...
              className="group inline-flex items-center justify-center gap-2 border-2 border-gray-300 dark:border-gray-600 hover:border-blue-400 dark:hover:border-blue-500 text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 px-3.5 sm:px-5 md:px-6 lg:px-8 py-2 sm:py-3 md:py-3.5 lg:py-4 rounded-lg sm:rounded-xl font-outfit font-semibold transition-all duration-300 hover:bg-blue-50 dark:hover:bg-blue-900/10 focus-override w-full sm:w-auto min-h-[40px] sm:min-h-[48px] md:min-h-[52px] lg:min-h-[56px] text-sm sm:text-base"
            >
              {secondaryButtonText}
