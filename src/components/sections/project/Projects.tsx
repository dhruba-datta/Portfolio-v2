          ...
          {filteredProjects.map((project, index) => (
            ...
            >
              <Link to={`/projects/${project.id}`} className="block">
                <div className="relative bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 h-[380px] border border-gray-200/50 dark:border-gray-700/50">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 bg-white/80 dark:bg-gray-900/80 backdrop-blur-md border-t border-gray-200/50 dark:border-gray-700/50">
                    <div className="p-6">
                      {/* Title */}
                      ...
                      <div className="flex gap-2 mb-4">
                        {project.github && (
                          <a
                            ...
                            target="_blank"
                            rel="noopener"
                            className="flex items-center gap-2 px-3 py-1.5 bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-300 rounded-lg text-xs font-medium transition-colors"
                      ...
                      <div className={`transition-all duration-300 overflow-hidden ${
                        ...
                        <div className="flex flex-wrap gap-1">
                          {project.tags.slice(0, 3).map((tag) => (
                            <span 
                              key={tag} 
                              className="px-2 py-1 bg-gray-200/80 dark:bg-gray-700/80 text-gray-700 dark:text-gray-300 rounded text-xs font-medium"
                            >
                              {tag}
                            </span>
                          ))}
