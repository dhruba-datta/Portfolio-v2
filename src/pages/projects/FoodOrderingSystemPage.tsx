          ...
          <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4 lg:gap-6">
            ...
            <div className="flex lg:hidden items-center mt-4">
              <a
                ...
                className="w-full inline-flex items-center justify-center gap-2 h-11 px-4 rounded-xl border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-800 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-700 focus-override text-sm font-medium font-outfit"
              ...
              <ul className="space-y-3 sm:space-y-2 text-gray-800 dark:text-gray-200">
                <li className="grid grid-cols-[20px_1fr] sm:grid-cols-[24px_1fr] items-start gap-2 sm:gap-3">
                  ...
                  <span className="text-sm sm:text-base">
                    <strong className="font-bold">C++:</strong> High-performance core programming language utilizing the Standard Template Library (STL) for efficient data processing.
                  </span>
                </li>
                <li className="grid grid-cols-[20px_1fr] sm:grid-cols-[24px_1fr] items-start gap-2 sm:gap-3">
                  <Code className="w-3.5 h-3.5 sm:w-4 sm:h-4 mt-0.5 sm:mt-1 text-gray-500 dark:text-gray-400 shrink-0" />
                  <span className="text-sm sm:text-base">
                    <strong className="font-bold">Object-Oriented Programming:</strong> Robust architecture employing Classes (Customer, getData), Multi-level Inheritance, and Encapsulation for modularity.
                  </span>
                </li>
                <li className="grid grid-cols-[20px_1fr] sm:grid-cols-[24px_1fr] items-start gap-2 sm:gap-3">
                  <Database className="w-3.5 h-3.5 sm:w-4 sm:h-4 mt-0.5 sm:mt-1 text-gray-500 dark:text-gray-400 shrink-0" />
                  <span className="text-sm sm:text-base">
                    <strong className="font-bold">File Handling:</strong> Persistent data storage mechanism using <code>fstream</code> library for creating, reading, and appending to text files.
                  </span>
                </li>
                <li className="grid grid-cols-[20px_1fr] sm:grid-cols-[24px_1fr] items-start gap-2 sm:gap-3">
                  <Terminal className="w-3.5 h-3.5 sm:w-4 sm:h-4 mt-0.5 sm:mt-1 text-gray-500 dark:text-gray-400 shrink-0" />
                  <span className="text-sm sm:text-base">
                    <strong className="font-bold">Console Interface:</strong> Interactive text-based user interface (TUI) with intuitive navigation menus and system commands.
                  </span>
                </li>
                <li className="grid grid-cols-[20px_1fr] sm:grid-cols-[24px_1fr] items-start gap-2 sm:gap-3">
                  <Settings className="w-3.5 h-3.5 sm:w-4 sm:h-4 mt-0.5 sm:mt-1 text-gray-500 dark:text-gray-400 shrink-0" />
                  <span className="text-sm sm:text-base">
                    <strong className="font-bold">Admin Controls:</strong> Secured, password-protected management dashboard allowing full control over order history and deletion.
                  </span>
                </li>
                <li className="grid grid-cols-[20px_1fr] sm:grid-cols-[24px_1fr] items-start gap-2 sm:gap-3">
                  <ShoppingCart className="w-3.5 h-3.5 sm:w-4 sm:h-4 mt-0.5 sm:mt-1 text-gray-500 dark:text-gray-400 shrink-0" />
                  <span className="text-sm sm:text-base">
                    <strong className="font-bold">Core Logic:</strong> Complex algorithms handling real-time bill calculation, change determination, and preparation time estimation.
                  </span>
                </li>
              </ul>
            </section>
