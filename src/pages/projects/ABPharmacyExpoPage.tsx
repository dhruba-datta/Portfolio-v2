...
const features = [
  'Sort by categories/companies',
  'Search & filter products',
  'Detailed product info',
  'Add to cart & order',
  'Market schedule chart',
  'WhatsApp integration',
  'Login via Google Sheet',
];
...
const ABPharmacyExpoPage = ({ isDark, toggleTheme }: ABPharmacyExpoPageProps) => (
  <div className="min-h-screen bg-white dark:bg-gray-900 transition-colors duration-300">
    ...
    <main className="container-max-width py-16">
      ...
      >
        <h1 className="text-5xl font-bold mb-4 text-gray-900 dark:text-white">AB-Pharmacy-Expo 💊</h1>
        <p className="text-lg text-gray-700 dark:text-gray-300 max-w-2xl mx-auto">
          Android app for medical store with direct ordering, business features, and a modern UI.
        </p>
        <a href="http://surl.li/lkiufr" target="_blank" rel="noopener" className="inline-block mt-6 px-6 py-2 bg-green-600 text-white rounded-lg font-semibold shadow hover:bg-green-700 transition">Demo</a>
        <a href="https://github.com/dhruba-datta/AB-Pharmacy-Expo" target="_blank" rel="noopener" className="ml-4 inline-block mt-6 px-6 py-2 bg-gray-800 text-white rounded-lg font-semibold shadow hover:bg-gray-900 transition">GitHub</a>
      </motion.div>
      <motion.section
        initial="hidden"
        whileInView="visible"
      ...
      >
        ...
        <div className="flex flex-wrap gap-3 justify-center">
          {techStack.map(t => (
            <span key={t} className="px-3 py-1 bg-green-100 dark:bg-green-900 text-green-700 dark:text-green-300 rounded text-sm font-medium">
              {t}
            </span>
          ))}
        </div>
