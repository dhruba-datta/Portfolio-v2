...
const EasyCookingPage = ({
  ...
  const chips = [
    ...
    { name: "CSS3", icon: <SiCss3 className="w-3.5 h-3.5" /> },
    { name: "Responsive Design", icon: <Smartphone className="w-3.5 h-3.5" /> },
    { name: "Multi-Cuisine", icon: <Globe2 className="w-3.5 h-3.5" /> },
    { name: "GitHub Pages", icon: <Github className="w-3.5 h-3.5" /> },
  ];
          ...
          <article className="space-y-20">
            ...
            <section id="tech" className="scroll-mt-28">
              ...
              <ul className="space-y-2 text-gray-800 dark:text-gray-200">
                <li className="grid grid-cols-[24px_1fr] items-start gap-3">
                  <SiHtml5 className="w-4 h-4 mt-1 text-gray-500 dark:text-gray-400" />
                  <span><b>HTML5</b> — Semantic markup for recipe content and structure.</span>
                </li>
                <li className="grid grid-cols-[24px_1fr] items-start gap-3">
                  <SiCss3 className="w-4 h-4 mt-1 text-gray-500 dark:text-gray-400" />
                  <span><b>CSS3</b> — Modern styling with responsive design patterns.</span>
                </li>
                <li className="grid grid-cols-[24px_1fr] items-start gap-3">
                  <Smartphone className="w-4 h-4 mt-1 text-gray-500 dark:text-gray-400" />
                  <span><b>Responsive Design</b> — Mobile-first approach for all devices.</span>
                </li>
                <li className="grid grid-cols-[24px_1fr] items-start gap-3">
                  <Globe2 className="w-4 h-4 mt-1 text-gray-500 dark:text-gray-400" />
                  <span><b>Multi-Cuisine Layout</b> — Organized sections for different cooking styles.</span>
                </li>
                <li className="grid grid-cols-[24px_1fr] items-start gap-3">
                  <Github className="w-4 h-4 mt-1 text-gray-500 dark:text-gray-400" />
                  <span><b>GitHub Pages</b> — Free static hosting with automatic deployment.</span>
                </li>
              </ul>
            </section>
            ...
            <section id="use-cases" className="scroll-mt-28">
              ...
              <ul className="list-disc pl-6 space-y-2 text-gray-800 dark:text-gray-200">
                <li>Home cooking enthusiasts learning new cuisines</li>
                <li>Cultural food exploration and traditional recipes</li>
                <li>Simple recipe reference for kitchen use</li>
                <li>Educational resource for cooking basics</li>
                <li>Template for other recipe-sharing websites</li>
              </ul>
            </section>
