...
const KingsleyGroupPage = ({
  ...
  const chips = [
    { name: "WordPress", icon: <FaWordpress className="w-3.5 h-3.5" /> },
    { name: "PHP 8", icon: <BiLogoPhp className="w-3.5 h-3.5" /> },
    { name: "MySQL", icon: <SiMysql className="w-3.5 h-3.5" /> },
    { name: "Yoast SEO", icon: <SiYoast className="w-3.5 h-3.5" /> },
    { name: "Cloudflare CDN", icon: <SiCloudflare className="w-3.5 h-3.5" /> },
    { name: "Elementor/Gutenberg", icon: <SiElementor className="w-3.5 h-3.5" /> },
  ];
  ...
  const toc = [
    ...
    { id: "how-to", label: "How to Manage", icon: <FileJson className="w-4 h-4" /> },
  ] as const;
      ...
      <main>
        ...
        <header className="max-w-6xl mx-auto px-4 md:px-6 -mt-2 md:-mt-4">
          <div className="flex items-start justify-between gap-6">
            ...
            {/* Right-side actions (mirror the KFC layout) */}
          ...
          <article className="space-y-20">
            ...
            <section id="tech" className="scroll-mt-28">
              ...
              <ul className="space-y-2 text-gray-800 dark:text-gray-200">
                <li className="grid grid-cols-[24px_1fr] items-start gap-3">
                  <FaWordpress className="w-4 h-4 mt-1 text-gray-500 dark:text-gray-400" />
                  <span>
                    <b>WordPress</b> — Custom theme setup, structured content model.
                  </span>
                </li>
                <li className="grid grid-cols-[24px_1fr] items-start gap-3">
                  <BiLogoPhp className="w-4 h-4 mt-1 text-gray-500 dark:text-gray-400" />
                  <span>
                    <b>PHP 8</b> — Template logic and performance-minded hooks.
                  </span>
                </li>
                <li className="grid grid-cols-[24px_1fr] items-start gap-3">
                  <SiMysql className="w-4 h-4 mt-1 text-gray-500 dark:text-gray-400" />
                  <span>
                ...
                <li className="grid grid-cols-[24px_1fr] items-start gap-3">
                  <SiYoast className="w-4 h-4 mt-1 text-gray-500 dark:text-gray-400" />
                  <span>
                    <b>Yoast SEO</b> — Meta, sitemaps, schema integration.
                  </span>
                </li>
                <li className="grid grid-cols-[24px_1fr] items-start gap-3">
                  <SiGoogleanalytics className="w-4 h-4 mt-1 text-gray-500 dark:text-gray-400" />
                  <span>
                    <b>GA4</b> — Events for forms, downloads, and outbound links.
                  </span>
                </li>
                <li className="grid grid-cols-[24px_1fr] items-start gap-3">
                  <SiCloudflare className="w-4 h-4 mt-1 text-gray-500 dark:text-gray-400" />
                  <span>
            ...
            <section id="use-cases" className="scroll-mt-28">
              ...
              <ul className="list-disc pl-6 space-y-2 text-gray-800 dark:text-gray-200">
                <li>Corporate site redesign for professional services</li>
                <li>SEO-driven content hub (Blogs, News, Resources)</li>
                <li>Sales enablement via downloadable resources</li>
                <li>Multi-location service and regional landing pages</li>
                <li>Editorial workflow for marketing teams</li>
              </ul>
            </section>
            ...
            <section id="how-to" className="scroll-mt-28">
              <div className="flex items-center gap-2 mb-4">
                ...
                <h2 className="text-2xl md:text-3xl font-bold leading-none">How to Manage</h2>
              </div>
