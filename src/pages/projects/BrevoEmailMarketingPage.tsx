            ...
            <section id="tech" className="scroll-mt-24 sm:scroll-mt-28">
              ...
              <ul className="space-y-3 sm:space-y-2 text-gray-800 dark:text-gray-200">
                ...
                <li className="grid grid-cols-[20px_1fr] sm:grid-cols-[24px_1fr] items-start gap-2 sm:gap-3">
                  ...
                  <span className="text-sm sm:text-base"><strong className="font-bold">Brevo (Sendinblue):</strong> Transactional email infrastructure providing high-deliverability SMTP services.</span>
                </li>
                <li className="grid grid-cols-[20px_1fr] sm:grid-cols-[24px_1fr] items-start gap-2 sm:gap-3">
                  <SiGooglesheets className="w-3.5 h-3.5 sm:w-4 sm:h-4 mt-0.5 sm:mt-1 text-gray-500 dark:text-gray-400 shrink-0" />
                  <span className="text-sm sm:text-base"><strong className="font-bold">Google Sheets:</strong> Flexible database for managing subscriber lists, campaign logs, and analytics.</span>
                </li>
                <li className="grid grid-cols-[20px_1fr] sm:grid-cols-[24px_1fr] items-start gap-2 sm:gap-3">
                  <SiWebflow className="w-3.5 h-3.5 sm:w-4 sm:h-4 mt-0.5 sm:mt-1 text-gray-500 dark:text-gray-400 shrink-0" />
                  <span className="text-sm sm:text-base"><strong className="font-bold">Webflow CMS:</strong> Source of truth for dynamic content assets used in automated newsletters.</span>
                </li>
                <li className="grid grid-cols-[20px_1fr] sm:grid-cols-[24px_1fr] items-start gap-2 sm:gap-3">
                  <Webhook className="w-3.5 h-3.5 sm:w-4 sm:h-4 mt-0.5 sm:mt-1 text-gray-500 dark:text-gray-400 shrink-0" />
                  <span className="text-sm sm:text-base"><strong className="font-bold">Webhook Node:</strong> Real-time listener enabling instant triggers from signup forms or external apps.</span>
                </li>
                <li className="grid grid-cols-[20px_1fr] sm:grid-cols-[24px_1fr] items-start gap-2 sm:gap-3">
                  <Code2 className="w-3.5 h-3.5 sm:w-4 sm:h-4 mt-0.5 sm:mt-1 text-gray-500 dark:text-gray-400 shrink-0" />
                  <span className="text-sm sm:text-base"><strong className="font-bold">Code Node (JS):</strong> Custom Javascript logic for parsing JSON payloads and formatting HTML strings.</span>
                </li>
              </ul>
            </section>
